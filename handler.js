...
export async function callUpdate(callUpdate) {
    ...
    let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;Q𝐮et𝐮𝐨  👑;;;\nFN:Q𝐮et𝐮𝐨 👑\nORG:Q𝐮et𝐮𝐨 👑\nTITLE:\nitem1.TEL;waid=52924358041:+51 924 358 041\nitem1.X-ABLabel:Q𝐮et𝐮𝐨 👑\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:Q𝐮et𝐮𝐨 👑\nEND:VCARD`
    await this.sendMessage(nk.from, { contacts: { displayName: 'Q𝐮et𝐮𝐨 👑', contacts: [{ vcard }] }}, {quoted: callmsg})
